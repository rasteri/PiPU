...
*/
    ...
    if (musicnum == 29) nesnum = 1; // intro
    else if (musicnum == 28) nesnum = 2; // inter
    else if (musicnum >= 1 && musicnum <= 4) nesnum = musicnum + 2; // Episode 1
    else if (musicnum == 10) nesnum = 7; // E2M1;
    else if (musicnum == 19) nesnum = 8; // E3M1
